...
let sample = [  "5,4"; "4,2"; "4,5"; "3,0"; "2,1";
                ...
                "2,6"; "5,1"; "1,2"; "5,5"; "2,5";
                "6,5"; "1,4"; "0,4"; "6,4"; "1,1";
                "6,1"; "1,0"; "0,5"; "1,6"; "2,0"; ] |> List.take 12
...
let len = if lines.Length = 12 then 7 else 71
let input = parse lines
let map = generateMap len (input |> Seq.truncate 1024 |> Seq.toList)


printMap map
match findPath map with
| Some minLen -> printfn $"Min len is {minLen}"
| _ -> printfn $"No path found"